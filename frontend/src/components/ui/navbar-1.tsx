...
const Navbar1 = () => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-sidebar text-sidebar-foreground rounded-full shadow-lg w-full max-w-3xl relative z-10">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {["Home", "Pricing", "Docs", "Projects"].map((item) => (
            ...
            >
              <a
                href="#"
                className="text-sm text-sidebar-foreground hover:text-foreground transition-colors font-medium"
              >
                {item}
              </a>
            </motion.div>
